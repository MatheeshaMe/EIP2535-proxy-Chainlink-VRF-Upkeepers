...
export interface VRFv2ConsumerAndAutomationContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "count"
      | "getRequestStatus"
...
export interface VRFv2ConsumerAndAutomationContract extends BaseContract {
  connect(runner?: ContractRunner | null): VRFv2ConsumerAndAutomationContract;
  waitForDeployment(): Promise<this>;

  interface: VRFv2ConsumerAndAutomationContractInterface;
